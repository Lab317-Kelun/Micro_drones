...
int main (int argc,char** argv){
    ...
    /*-------------------------------------------------------------------------------------------------*/        
    fly_control_with_time(aim_pos,pos_client, 0 , 0, 1.45 , -90*PI/180 , ON,0.75f,100, //x y z yaw model time hz
                        3*PI/180 , 0.1f, 3*PI/180, 25.0f, 25.0f);          //角度精度   位置精度 ff                    
    /*-------------------------------------------------------------------------------------------------*/            
    //视觉纠正圆环
    /*-------------------------------------------------------------------------------------------------*/ 
    fly_cv_control_with_time(aim_cv_pos,pos_cv_client, 1.45, CV_task_circle, cv, 1.0f, 100, // z model vision cv_time cv_hz
                        3*PI/180 , 25);          //视觉角度精度   视觉像素精度 ff 
    //穿越圆环
    /*-------------------------------------------------------------------------------------------------*/ 
    fly_vel_control_with_time(vel_pos,vel_client, 2.1 , 0.0, 1.45 ,-90*PI/180, 0.5, 0.0 ,0.0, Vel_circle,0.001f,100, //x y z yaw vel_x vel_y model vel_time vel_hz
                        3*PI/180 , 0.15f);           //vel角度精度   vel位置精度 ff 
    //降落
    /*-------------------------------------------------------------------------------------------------*/
    fly_vel_control_with_time(vel_pos,vel_client, 0.0 , 0, 0 ,-90*PI/180, 0.0, 0.0 ,-0.5, Vel_Land,1.0f,100, //x y z yaw vel_x vel_y vel_z model vel_time vel_hz
